...
public class LAutoGearSwitchTask extends LTask {
    enum GearType{
        TOOL,
        WEAPON
    }

    public static LAutoGearSwitchTask getActiveTask(){
        return (LAutoGearSwitchTask) LTask.getActiveLTask(LTaskType.AUTO_GEAR_SWITCHER, LAutoGearSwitchTask.class);
    }

    public LAutoGearSwitchTask(Object... args) {
        super(args);
