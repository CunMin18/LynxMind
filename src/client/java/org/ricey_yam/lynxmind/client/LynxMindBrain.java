...
import org.ricey_yam.lynxmind.client.task.non_temp.life.sub.LAutoGearSwitchTask;
import org.ricey_yam.lynxmind.client.task.non_temp.life.sub.LAutoHeartbeatTask;
...
public class LynxMindBrain {
    ...
    public static void wake(){
        ...
        /// 自动切换工具/武器
        LynxMindEndTickEventManager.registerTask(new LAutoGearSwitchTask());
    }
    /// AI关闭服务,需要取消所有定时任务
